...
class TransformerDetector(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        # save_image(images[0], './img0.jpg', normalize=True) 
        # save_image(images[1], './img1.jpg', normalize=True)
        # save_image(tmp_images[0], './img0_tmp.jpg', normalize=True) # RGB
        # save_image(tmp_images[1], './img1_tmp.jpg', normalize=True)
        ...
        if self.training:
            ...
            save_image(rec_img, './img_rec.jpg',normalize=True) 
            save_image(tmp_images.tensor, './img_tmp.jpg', normalize=True)
            breakpoint()
    ...
    def prepare_targets(self, targets):
        ...
        for targets_per_image in targets:
            h, w = targets_per_image['height'], targets_per_image['width']
